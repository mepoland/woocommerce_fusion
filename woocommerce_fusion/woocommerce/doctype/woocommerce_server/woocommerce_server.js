...
frappe.ui.form.on("WooCommerce Server", {
  refresh: function (frm) {
    ...
    // Set the Options for order_field_map field on 'Sales Orders' > 'Order Header Fields Mapping' child table
    frappe.call({
      method: "get_item_docfields",
      doc: frm.doc,
      args: {
      ...
      callback: function (r) {
        ...
        // Set the Options property
        frm.fields_dict.order_field_map.grid.update_docfield_property(
          "erpnext_field_name",
          "options",
          options,
        );
